...
private:
    ...
    static clsUser _ConvertLinetoUserObject(string Line, string Seperator = "#//#")
    {
        ...
        vUserData = clsString::SplitEachWordInVector(Line, Seperator);
    ...
    static stLoginRegisterRecord _ConvertLoginRegisterLineToRecord(string Line)
    {
        ...
        vector<string>LoginRegisterDataLine = clsString::SplitEachWordInVector(Line, "#//#");
    ...
    string _PrepareLogInRecord(string Seperator = "#//#")
    {
        ...
        LoginRecord += clsUtil::Encryption(Password) + Seperator;
...
public:
    ...
    {
        enAll = -1,
        pListClient = 1, pNewClient = 2,
        pDeleteClient = 4, pUpdateClient = 8,
        pFindClient = 16, pTransactions = 32,
        pMangerUsers = 64,pShowLoginRegister=128
    };
    ...
    bool CheckAccessPermission(enPermissions Permission)
    {
        ...
        if ((this->Permissions & Permission) == enPermissions::enAll)
            return true;
